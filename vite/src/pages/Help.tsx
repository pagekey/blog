...
export default function HelpPage() {
    const topics = [
        ...
        },
        {
            ...
            description: "Configuring secure reverse proxies, configuring internal DNS, setting up SSL certificates, and managing automated local backups."
        },
        {
    ...
    return (
        <Layout>
            <section className="relative overflow-hidden">
                {/* Background Glow matching Homepage styling */}
                ...
                <div className="mx-auto max-w-4xl px-6 py-24 text-center">
                    ...
                    <h1 className="text-4xl font-extrabold tracking-tight md:text-6xl">
                        ...
                        <span className="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent">(30 min call)</span>
                    </h1>

                    <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed">
                        Skip hours of reading conflicting documentation or outdated forum threads.
                        Book a focused, engineer-to-engineer session to unblock your setup and resolve your architecture challenges.
                    </p>

                    <div className="mt-10 flex justify-center">
                        <Button size="lg" className="bg-orange-600 hover:bg-orange-500 text-white transition-colors" asChild>
                            <a href="https://cal.com/pagekey/self-hosting-consulting" target="_blank" rel="noreferrer">
                                Book a 30-minute call ($20)
            ...
            <section className="mx-auto max-w-4xl px-6 py-12">
                <div className="mb-10">
                    <h2 className="text-2xl font-bold tracking-tight text-center md:text-left">What We Can Resolve</h2>
                    <p className="mt-2 text-muted-foreground text-center md:text-left">
                        Bring your broken configurations, architecture diagrams, or active terminal errors.
                    </p>
                </div>
            ...
            <section className="mx-auto max-w-4xl px-6 py-16 text-center">
                <Card className="border-orange-500/20 bg-gradient-to-br from-card to-orange-500/[0.02] p-8 md:p-12">
                    <CardContent className="flex flex-col items-center p-0">
                        <h2 className="text-2xl font-bold tracking-tight">Ready to clear the backlog?</h2>
